...
<div class="modal__content-change-logic">
    <input data-when_change="<?= _PROPERTY_IN_APPLICATION['expertise_purpose'] ?>" data-target_change="<?= _PROPERTY_IN_APPLICATION['type_of_work'] ?>" type="hidden" value='<?= $typeOfWorksIH ?>'>
</div>
