class FileNeeds {
   ...
   getFileNeeds() {
      return this.#file_needs;
   }

   getFileNeedsJSON() {
      return JSON.stringify(this.#file_needs);
   }

   putFileToSave(id_file, mapping_level_1, mapping_level_2) {
      let to_save = this.#file_needs.to_save;
   ...
   putFileToDelete(id_file, mapping_level_1, mapping_level_2) {
      let file_data = FileNeeds.getFileData(id_file, mapping_level_1, mapping_level_2);
      let to_save = this.#file_needs.to_save;
   ...
   getFileData(id_file, mapping_level_1, mapping_level_2) {
      return {
   ...
   clear() {
      ...
      // FileNeeds.file_needs.to_save.clear();
      // FileNeeds.file_needs.to_delete.clear();
      // FileNeeds.file_needs.to_save = [];
      // FileNeeds.file_needs.to_delete = [];

      /*FileNeeds.file_needs = {
         to_save: [],
         to_delete: []
      };*/
   }
