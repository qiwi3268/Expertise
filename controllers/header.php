...
switch(_URN_){
    ...
    case 'home/application/create' :
        ...
        $sourcesFiles = [...GetFontAwesome5Case(),
                         ...
                         ...CreateSource('js', TMP_JS, 'ErrorHandler.js', 'main.js', 'sidebar.js', 'section.js', 'validation.js', 'cards.js', 'modal.js', 'calendar.js', 'radio.js', 'checkbox.js', 'save_application.js', 'SignHandler.js', 'Sign_Handler.js', 'PerfectCades.js', 'BrowserHelper.js', 'FileChecker.js', 'file_needs.js', 'file_download.js', 'file_actions.js', 'test.js')
        ];
        break;
