...
// Обозначения ролей в соответствии с `code_role`.`id`
define('ROLE_ID', [
    'APP'     => 1,  // Заявитель
    'ADM'     => 2,  // Администратор
    'FRE_EXP' => 3,  // Внештатный эксперт
    'EMP_EXP' => 4,  // Сотрудник экспертного отдела
    'EMP_EST' => 5,  // Сотрудник сметного отдела
    'EMP_PTO' => 6,  // Сотрудник производственно-технического отдела
    'EMP_PKR' => 7,  // Сотрудник отдела правовой и кадровой работы
    'EMP_BUH' => 8,  // Сотрудник бухгалтерии
    'EMP_RKS' => 9,  // Сотрудник отдела развития, контроля, сопровождения
    'ZAM'     => 10, // Заместитель руководителя учреждения
    'BOSS'    => 11, // Руководитель учреждения
    'REPORT'  => 12  // Формирование отчетов
]);
