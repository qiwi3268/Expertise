...
class MiscInitialization{
    ...
    // Принимает параметры-----------------------------------
    // singleMiscs ?array : одиночные справочники, которые необходимо разбить по страницам
    ...
    // Принимает параметры-----------------------------------
    // dependentMiscs ?array : зависимые справочники, которые необходимо разбить по страницам
    // Возвращает параметры----------------------------------
    // array : разбитые постранично справочники
    //
    ...
    // Предназначен для получения названий справочников
    // Отдает константу класса MISC_NAMES с очищенным префиксом CORR_MISC_PREFIX
    // Возвращает параметры----------------------------------
    // array : названия справочников
    //
