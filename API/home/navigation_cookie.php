...
if(!isset(_NAVIGATION_SORTING[$P_view_name])) exit_incorrectValue('view_name', $P_view_name);
...
if(isset($P_data_per_page)){
    ...
    if(!isset(_NAVIGATION_SORTING[$P_view_name][$P_sort_name])) exit_incorrectValue('sort_name', $P_sort_name);
